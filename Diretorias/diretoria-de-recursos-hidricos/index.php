...
<div id="centro">
    <p>A Diretoria de Recursos Hídricos, foi criada pela LEI N° 815 DE 7 DE JULHO DE 2011, que coordena e executa as Política Recursos Hídricos do Estado. Está subordinada à Presidência da Fundação Estadual do Meio Ambiente e Recursos Hídricos.</p>

    <p>Desta forma, a diretoria tem como objetivo: assegurar a disponibilidade de água no Estado, garantir o uso racional e integrado dos recursos hídricos, de acordo com as diretrizes de desenvolvimento sustentável.</p>

    <p>Os recursos hídricos são as águas superficiais e subterrâneas disponíveis para uso da humanidade. Ou seja, como se denomina a reserva de água doce que está acessível para a atual capacidade tecnológica da sociedade, com custos compatíveis aos seus diversos usos.</p>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">DIVISÃO DE OUTORGA</h5>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">DIVISÃO DE PLANEJAMENTO HÍDRICO</h5>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">DIVISÃO DE SEGURANÇA DE BARRAGEM</h5>
      </div>
    </div>
  </div>
</div> <!-- Final - Card   -->
  ...
  <div class="col">
    <div class="card">
      <img src="../../imagens/map.jpg" class="card-img-top"
        alt="Los Angeles Skyscrapers" />
      <div class="card-body">
        <h5 class="card-title">NÍVEL DOS RIOS</h5>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="../../imagens/map.jpg" class="card-img-top"
        alt="Skyscrapers" />
      <div class="card-body">
        <h5 class="card-title">OUTORGA</h5>
      </div>
    </div>
  </div>
</div> <!-- Final - Card   -->
